...
**The information in this document is obsolete**

Nowadays you should probably use Emacs+SLIME.
...
1.  [Installing Emacs](#Installing Emacs)

2.  [Installing additional Emacs
    utilities](#Installing additional Emacs utilities) (optional)

3.  [Installing on-line
    documentation](#Installing on-line documentation) (optional)

4.  [Installing CLISP](#Installing CLISP) (optional)

5.  [Installing ACL](#Installing ACL) (optional)

6.  [Installing LispWorks](#Installing LispWorks) (optional)

7.  [Installing Corman CL](#Installing Corman CL) (optional)

8.  [Configuration steps](#Configuration steps)

9.  [Testing the environments](#Testing the environments)
...
-   Download the precompiled [Emacs](http://www.gnu.org/software/emacs/)
    binaries for Windows from <http://ftp.gnu.org/pub/gnu/windows/emacs/emacs-21.3-fullbin-i386.tar.gz>
...
-   OPTIONAL: The [Emacs Code Browser](http://ecb.sourceforge.net/)
    ...
    are all in the `C:\home\site\` directory and that they are named
...
-   Create a file named `clisprc.lisp` in the `C:\home` directory. This
...
-   Start Emacs (either by using the Start menu's Gnu Emacs shortcut or
    ...
    -   If you installed CLISP and ILISP, do the following:
        ...
        -   After starting ILISP/CLISP in Emacs, use "M-x
            ilisp-compile-inits" to compile the CLISP Lisp
...
-   Following is a brief explanation of each of the sections of the
    ...
    -   **MS Windows Customizations:** These settings make Emacs feel
